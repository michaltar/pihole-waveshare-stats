...
api_url = 'http://192.168.0.4/admin/api.php'
bg_color = 0
fill_color = 255
...
image = Image.new('1', (epd3in7.EPD_WIDTH, epd3in7.EPD_HEIGHT),
                  255)  # 255: clear the frame
draw = ImageDraw.Draw(image)

width = epd3in7.EPD_WIDTH
height = epd3in7.EPD_HEIGHT
...
while True:
    ...
    # 255: clear the frame
    time_image = Image.new('1', (height, width), bg_color)
    draw = ImageDraw.Draw(time_image)
    font = ImageFont.truetype("/home/pi/finally/slkscr.ttf", 15)
    ...
    draw.text((x, top + 75), "Ads Blocked: " +
              str(ADSBLOCKED), font=font, fill=fill_color)
    draw.text((x, top + 90), "Clients:     " +
              str(CLIENTS), font=font, fill=fill_color)
    draw.text((x, top + 105), "DNS Queries: " +
              str(DNSQUERIES), font=font, fill=fill_color)
